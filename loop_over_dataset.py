...
RET_DARKNET_SEQ1 = 'results_sequence_1_darknet'
RET_DARKNET_SEQ2 = 'results_sequence_2_darknet'
RET_DARKNET_SEQ3 = 'results_sequence_3_darknet'

RET_RESNET_SEQ1 = 'results_sequence_1_resnet'
RET_RESNET_SEQ2 = 'results_sequence_2_resnet'
RET_RESNET_SEQ3 = 'results_sequence_3_resnet'

##################
## Set parameters and perform initializations

## Select Waymo Open Dataset file and frame numbers
seq = SEQUENCE1         # options are SEQUENCE1 or SEQUENCE2 or SEQUENCE3
...
configs_det = det.load_configs(model_name) 
...
exec_detection = [] # options are 'bev_from_pcl' 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file
